...
//
//	mockgen -destination=mock_outbox_test.go -package=otel_test -source=outbox.go
//
...
func (m *MockOutboxRepository) InsertLiveStreamsFound(ctx context.Context, ls []domain.LiveStream) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InsertLiveStreamsFound", ctx, ls)
	ret0, _ := ret[0].(error)
	return ret0
}

// InsertLiveStreamsFound indicates an expected call of InsertLiveStreamsFound.
func (mr *MockOutboxRepositoryMockRecorder) InsertLiveStreamsFound(ctx, ls any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InsertLiveStreamsFound", reflect.TypeOf((*MockOutboxRepository)(nil).InsertLiveStreamsFound), ctx, ls)
}
